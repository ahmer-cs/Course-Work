...
a=lin_reg.predict([[2016]])
print('temp in 2016(by linear reg)=',a)

# Predicting a new result with Polynomial Regression
b=lin_reg_2.predict(poly_reg.fit_transform([[2016]]))
#predicting newresults
print('temp in 2016(by polynomial reg)=',b)

# Predicting a new result
c= regressor.predict([[2016]])
print('temp in 2016(by decision tree)=',c)
